...
> - <责任人 — 做什么 — 何时之前 — 优先级>
>
> 截止时间避免「待定」，写「本周内/两周内/Q2 末/X 月 X 日前」等可锚定形式。
...
- 前面可以有结构化摘要、结论、待办或风险；后面的展开部分应贴近讨论脉络，不要机械套框。
...
4. 信息取舍：说明如何处理事实、判断、行动项、风险、引用和不确定内容。
  ...
  newCustomScene(seed, baseMode, prompt) {
    ...
    return {
      ...
      prompt: prompt || [
        ...
        "- 重点内容：说明必须识别哪些信息，例如事实、结论、待办、风险、争议、关键原话、术语、外语内容。",
